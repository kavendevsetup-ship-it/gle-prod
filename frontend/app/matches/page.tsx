        ...
        if (
          ...
          setPricing({
            ...
            monthly_original_price:
              Number.isFinite(response.monthly_original_price) && (response.monthly_original_price ?? 0) > 0
                ? response.monthly_original_price
                : FALLBACK_PRICING.monthly_original_price,
            enable_weekly:
              typeof response.enable_weekly === "boolean"
                ? response.enable_weekly
                : FALLBACK_PRICING.enable_weekly,
            enable_monthly:
              typeof response.enable_monthly === "boolean"
                ? response.enable_monthly
                : FALLBACK_PRICING.enable_monthly,
            enable_match:
              typeof response.enable_match === "boolean"
                ? response.enable_match
            ...
            weekly_offer_active:
              typeof response.weekly_offer_active === "boolean"
                ? response.weekly_offer_active
                : FALLBACK_PRICING.weekly_offer_active,
            monthly_offer_active:
              typeof response.monthly_offer_active === "boolean"
                ? response.monthly_offer_active
